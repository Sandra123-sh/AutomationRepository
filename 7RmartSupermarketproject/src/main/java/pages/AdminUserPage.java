...
public class AdminUserPage {
	...
	@FindBy(xpath="//i[@class='nav-icon fas fa-users']")private WebElement selectadminuser;
	...
	@FindBy(xpath="//input[@id='username']")private WebElement enterusername;
	@FindBy(xpath="//input[@id='password']")private WebElement enterpassword;
	@FindBy(xpath="//select[@id='user_type']")private WebElement selectuserid;
	...
	@FindBy(xpath="//p[text()='Manage Users']")private WebElement clickmanageuser1;
	@FindBy(xpath="//a[@class='btn btn-rounded btn-primary']")private WebElement clicksearch;
	@FindBy(xpath="//input[@id='un']")private WebElement enterusername1;
	@FindBy(xpath="//select[@id='ut']")private WebElement selectuserid1;
	@FindBy(xpath="//button[@class='btn btn-block-sm btn-danger']")private WebElement clicksearch1;
	@FindBy(xpath="//div[@class='alert alert-danger alert-dismissible']")private WebElement alertdisplayed;
	@FindBy(xpath="//button[@class='btn btn-block-sm btn-danger']")private WebElement serachicondisplayed;
    ...
    public void enterPasswordOnPasswordTitle(String passwordvalue)
    {
    	enterpassword.sendKeys(passwordvalue);
    	
    }
    public void selectUseridType()
    {
    ...
    public void clickOnAdminUser1()
    {
    	clickadminuser.click();
    	
    }
    public void clickOnManageUser1()
    {
    	clickmanageuser1.click();
    }
    public void clickOnSearch()
    {
    	clicksearch.click();
    }
    public void enterUsername1(String usernamevalue)
    {
