...
public class LoginTest extends Base {
	...
	@Test(description= "verify whether user is able to successfully login with valid credentials",groups= {"smoke"})
	...
	@Test(description= "verify whether user is able to successfully login with valid credentials",groups= {"smoke"},dataProvider="loginProvider")
